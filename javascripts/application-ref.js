...
function (e) {
    ...
    e.mask = {
        ...
        mask: function (r, i) {
            ...
            return e.each(r.split(""), function (e, t) {
                ...
                function m(e) {
                    for (var t = e, n = i.placeholder; t < l; t++)
                        if (u[t]) {
                            var r = p(t),
                                s = c[t];
                            c[t] = n;
                ...
                s.data(e.mask.dataName, function () {
                    ...
                    E(), s.val() != h && s.change()
                }).bind("keydown.mask", g).bind("keypress.mask", y).bind(t, function () {
                    setTimeout(function () {
                        s.caret(E(!0))
                    }, 0)
                }), E()
    ...
    var a = "2.5.2",
        ...
        x, T = function (e, n, r, i) {
            ...
            return s = ["&#173;", "<style>", e, "</style>"].join(""), a.id = h, l.innerHTML += s, l.appendChild(a), f || c.appendChild(l), o = n(a, e), f ? a.parentNode.removeChild(a) : l.parentNode.removeChild(l), !! o
        }, N = function (t) {
            var n = e.matchMedia || e.msMatchMedia;
            if (n) return n(t).matches;
            var r;
            return T("@media " + t + " { #" + h + " { position: absolute; } }", function (t) {
    ...
    var L = function (n, r) {
        ...
        T(i, function (n, r) {
            ...
            f.touch = "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch || (a.touch && a.touch.offsetTop) === 9
        }, s, r)
    }([, ["@media (", g.join("touch-enabled),("), h, ")", "{#touch{top:9px;position:absolute}}"].join("")], [, "touch"]);
    y.touch = function () {
        return f.touch
    };
    for (var A in y) k(y, A) && (x = A.toLowerCase(), f[x] = y[A](), E.push((f[x] ? "" : "no-") + x));
    return f.addTest = function (e, t) {
        ...
        return f
    }, r(""), p = v = null, f._version = a, f._prefixes = g, f.mq = N, f.testStyles = T, c.className = c.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (l ? " js " + E.join(" ") : ""), f
}(this, this.document),
function (e, t, n) {
    function r(e) {
...
function (e) {
    e("a[data-reveal-id]").live("click", function (t) {
        ...
        return t = e.extend({}, n, t), this.each(function () {
            ...
            function l() {
                s || (f(), t.animation === "fadeAndPop" && (n.css({
                    top: e(document).scrollTop() - i,
                    opacity: 0,
                    visibility: "visible"
                }), o.fadeIn(t.animationSpeed / 2), n.delay(t.animationSpeed / 2).animate({
                    top: e(document).scrollTop() + r + "px",
                    opacity: 1
                }, t.animationSpeed, function () {
                    n.trigger("reveal:opened")
                })), t.animation === "fade" && (n.css({
                    opacity: 0,
                    visibility: "visible",
            ...
            function c() {
                s || (f(), t.animation === "fadeAndPop" && (n.animate({
                ...
                }), o.delay(t.animationSpeed).fadeOut(t.animationSpeed, function () {
                    n.trigger("reveal:closed")
                })), t.animation === "fade" && (n.animate({
                    opacity: 0
                }, t.animationSpeed, function () {
                    n.css({
                        opacity: 1,
            ...
            function h() {
                n.unbind(".reveal"), o.unbind(".reveal"), e("." + t.dismissModalClass).unbind(".reveal"), e("body").unbind(".reveal")
            }
            var n = e(this),
                r = parseInt(n.css("top"), 10),
                i = n.height() + r,
                s = !1,
                o = e(".reveal-modal-bg"),
                u;
            o.length === 0 && (o = e('<div class="reveal-modal-bg" />').insertAfter(n), o.fadeTo("fast", .8)), n.bind("reveal:open.reveal", l), n.bind("reveal:close.reveal", c), n.bind("reveal:opened.reveal reveal:closed.reveal", a), n.bind("reveal:closed.reveal", h), n.bind("reveal:open.reveal", t.open), n.bind("reveal:opened.reveal", t.opened), n.bind("reveal:close.reveal", t.close), n.bind("reveal:closed.reveal", t.closed), n.trigger("reveal:open"), u = e("." + t.dismissModalClass).bind("click.reveal", function () {
                n.trigger("reveal:close")
            }), t.closeOnBackgroundClick && (o.css({
                cursor: "pointer"
            }), o.bind("click.reveal", function () {
                n.trigger("reveal:close")
            })), e("body").bind("keyup.reveal", function (e) {
                e.which === 27 && n.trigger("reveal:close")
            })
        })
    }
}(jQuery),
function (e) {
    ...
    var t = {
        ...
        setDimentionsFromLargestSlide: function () {
            var t = this,
                n;
            t.$element.add(t.$wrapper).width(this.$slides.first().width()), t.$element.add(t.$wrapper).height(this.$slides.first().height()), t.orbitWidth = this.$slides.first().width(), t.orbitHeight = this.$slides.first().height(), n = this.$slides.first().findFirstImage().clone(), this.$slides.each(function () {
                var r = e(this),
                    i = r.width(),
                    s = r.height();
                i > t.$element.width() && (t.$element.add(t.$wrapper).width(i), t.orbitWidth = t.$element.width()), s > t.$element.height() && (t.$element.add(t.$wrapper).height(s), t.orbitHeight = t.$element.height(), n = e(this).findFirstImage().clone()), t.numberSlides += 1
                ...
                t.orbitWidth = t.$element.width(), t.orbitHeight = t.$element.height()
            }))
        },
        lock: function () {
            this.locked = !0
        ...
        setupBulletNav: function () {
            this.$bullets = e(this.bulletHTML), this.$wrapper.append(this.$bullets), this.$slides.each(this.addBullet), this.$element.addClass("with-bullets"), this.options.centerBullets && this.$bullets.css("margin-left", -this.$bullets.width() / 2)
        },
...
}(jQuery), jQuery.foundation = jQuery.foundation || {}, jQuery.foundation.customForms = jQuery.foundation.customForms || {}, jQuery(document).ready(function (e) {
    function t(t) {
        e("form.custom input:" + t).each(function () {
            var n = e(this).hide(),
                r = n.next("span.custom." + t);
            r.length === 0 && (r = e('<span class="custom ' + t + '"></span>').insertAfter(n)), r.toggleClass("checked", n.is(":checked")), r.toggleClass("disabled", n.is(":disabled"))
        })
    }

    function n(t) {
        var n = e(t),
            r = n.next("div.custom.dropdown"),
            i = n.find("option"),
            s = 0,
            o;
        if (n.hasClass("no-custom")) return;
        r.length === 0 ? ($customSelectSize = "", e(t).hasClass("small") ? $customSelectSize = "small" : e(t).hasClass("medium") ? $customSelectSize = "medium" : e(t).hasClass("large") ? $customSelectSize = "large" : e(t).hasClass("expand") && ($customSelectSize = "expand"), r = e('<div class="custom dropdown ' + $customSelectSize + '"><a href="#" class="selector"></a><ul></ul></div>"'), i.each(function () {
            o = e("<li>" + e(this).html() + "</li>"), r.find("ul").append(o)
        }), r.prepend('<a href="#" class="current">' + i.first().html() + "</a>"), n.after(r), n.hide()) : (r.find("ul").html(""), i.each(function () {
            o = e("<li>" + e(this).html() + "</li>"), r.find("ul").append(o)
        })), r.toggleClass("disabled", n.is(":disabled")), i.each(function (t) {
            this.selected && (r.find("li").eq(t).addClass("selected"), r.find(".current").html(e(this).html()))
        }), r.css("width", "inherit"), r.find("ul").css("width", "inherit"), r.find("li").each(function () {
            r.addClass("open"), e(this).outerWidth() > s && (s = e(this).outerWidth()), r.removeClass("open")
        }), r.is(".small, .medium, .large, .expand") || (r.css("width", s + 18 + "px"), r.find("ul").css("width", s + 16 + "px"))
    }
    e.foundation.customForms.appendCustomMarkup = function () {
        t("checkbox"), t("radio"), e("form.custom select").each(function () {
            n(this)
        })
...
function (e) {
    ...
    e("form.custom span.custom.checkbox").live("click", function (t) {
    ...
    }), e("form.custom select").live("change", function (n) {
        t(e(this))
    }), e("form.custom label").live("click", function (t) {
        var i = e("#" + e(this).attr("for")),
            s, o;
        ...
        var n = e(this),
            ...
            i = r.prev(),
            s = 0;
        t.preventDefault(), t.stopPropagation(), n.closest("ul").find("li").removeClass("selected"), n.addClass("selected"), r.removeClass("open").find("a.current").html(n.html()), n.closest("ul").find("li").each(function (e) {
            n[0] == this && (s = e)
...
function (e, t, n) {
            ...
            if (t.is(":password")) {
                if (!t.data("placeholder-textinput")) {
                    try {
                        ...
                        e = n("<input>").attr(n.extend(u(this), {
                            type: "text"
                        }))
                    }
                    e.removeAttr("name").data("placeholder-password", !0).data("placeholder-id", i).bind("focus.placeholder", a), t.data("placeholder-textinput", e).data("placeholder-id", i).before(e)
                }
    ...
    var r = "placeholder" in t.createElement("input"),
        ...
        s = n.fn,
        o;
    r && i ? (o = s.placeholder = function () {
        return this
    }, o.input = o.textarea = !0) : (o = s.placeholder = function () {
        return this.filter((r ? "textarea" : ":input") + "[placeholder]").not(".placeholder").bind("focus.placeholder", a).bind("blur.placeholder", f).trigger("blur.placeholder").end()
    }, o.input = r, o.textarea = i, n(function () {
...
function (e) {
    var t = {
        ...
        pollInterval: 1e3
            ...
            init: function (r) {
                return this.each(function () {
                    var r, i, s, o;
                    e(window).data("tooltips", "init"), r = e(".has-tip"), i = e(".tooltip"), s = function (e, t) {
                        return '<span data-id="' + e + '" class="tooltip">' + t + '<span class="nub"></span></span>'
                    }, o = setInterval(n.isDomResized, t.pollInterval), i.length < 1 && r.each(function (t) {
                        var r, i, o, u, a;
                        r = e(this), o = "foundationTooltip" + t, u = r.attr("title"), a = r.attr("class"), r.data("id", o), i = e(s(o, u)), i.addClass(a).removeClass("has-tip").appendTo("body"), Modernizr.touch && i.append('<span class="tap-to-close">tap to close </span>'), n.reposition(r, i, a), i.fadeOut(150)
                    }), e(window).on("resize.tooltip", function () {
                        var t = e(".tooltip");
                        t.each(function () {
                            var t, i, s, o;
                            t = e(this).data(), i = r = e(".has-tip"), s = e(this), o = s.attr("class"), r.each(function () {
                                e(this).data().id == t.id ? i = e(this) : i = i
                            }), n.reposition(i, s, o)
                        })
                    }), Modernizr.touch ? (e(".tooltip").on("click.tooltip touchstart.tooltip touchend.tooltip", function (t) {
                        t.preventDefault(), e(this).fadeOut(150)
                    }), r.on("click.tooltip touchstart.tooltip touchend.tooltip", function (t) {
                        t.preventDefault(), e(".tooltip").hide(), e("span[data-id=" + e(this).data("id") + "].tooltip").fadeIn(150), r.attr("title", "")
                    })) : r.hover(function () {
                        e("span[data-id=" + e(this).data("id") + "].tooltip").fadeIn(150), r.attr("title", "")
                    }, function () {
                        e("span[data-id=" + e(this).data("id") + "].tooltip").fadeOut(150)
                    })
                })
            },
            reload: function () {
            ...
            destroy: function () {
                return this
                    .each(function () {
                        e(window).unbind(".tooltip"), e(".has-tip").unbind(".tooltip"), e(".tooltip").each(function (t) {
                            e(e(".has-tip").get(t)).attr("title", e(this).text())
                        }).remove()
                    })
            },
            reposition: function (t, n, r) {
                var i, s, o, u, a, f;
                i = t.data("width"), s = n.children(".nub"), o = s.outerHeight(), u = s.outerWidth(), f = function (e, t, n, r, i, s) {
                    return e.css({
                        top: t,
                        bottom: r,
                        left: i,
    ...
    function t(t) {
        var n = t.closest("dl").find("a.active"),
            r = t.attr("href") + "Tab";
        r = r.replace(/^.+#/, "#"), n.removeClass("active"), t.addClass("active"), e(r).closest(".tabs-content").children("li").hide(), e(r).css("display", "block")
    }
    e("dl.tabs dd a").live("click", function (n) {
        t(e(this))
    }), window.location.hash && (t(e('a[href="' + window.location.hash + '"]')), e.foundation.customForms.appendCustomMarkup()), e(".alert-box").delegate("a.close", "click", function (t) {
        t.preventDefault(), e(this).closest(".alert-box").fadeOut(function (t) {
            e(this).remove()
        })
    }), e("input, textarea").placeholder(), e(this).tooltips();
    var n = !1;
    e(".nav-bar a.flyout-toggle").live("click", function (t) {
        t.preventDefault();
        var r = e(this).siblings(".flyout");
        n === !1 && (e(".nav-bar .flyout").not(r).slideUp(500), r.slideToggle(500, function () {
            n = !1
        })), n = !0
    }), Modernizr.touch ? (e(".nav-bar>li.has-flyout>a.main").css({
        "padding-right": "75px"
    }), e(".nav-bar>li.has-flyout>a.flyout-toggle").css({
        "border-left": "1px dashed #eee"
    })) : e(".nav-bar>li.has-flyout").hover(function () {
        e(this).children(".flyout").show()
    }, function () {
        e(this).children(".flyout").hide()
    })
}), $("[data-tablet-hover-hack]").on("touchend", function (e) {
    var t = this,
        n = "tablet-hover-active";
    return e.preventDefault(), $(this).toggleClass(n), $(document).bind("touchend.tablet-hover-hack", function () {
        $(t).removeClass(n), $(document).unbind(".tablet-hover-hack")
    }), !1
}), $(document).on("page:change", function () {
    $("#topMenu").css("margin-top", $("#topMenu").height() * -1)
}), $(document).on("click", "#sidebarButton", function (e) {
    e.preventDefault(), $("body").toggleClass("active")
}), $(document).on("click", "#menuButton", function (e) {
    e.preventDefault(), $("body").toggleClass("active-menu")
}), $(document).on("click", "#switchPanels dd", function (e) {
    e.preventDefault();
    var t = $(this).children("a").attr("href"),
        n = $(t).index();
    $(this).toggleClass("active").siblings().removeClass("active"), $(t).parent().css("left", n * -100 + "%")
...
function (e) {
    ...
    function r(t) {
        var n = t.find(".attached");
        n.detach(), n.find("li.has-dropdown>a").each(function () {
            var t = e(this),
                n = t.siblings("ul.dropdown"),
                r = e('<li class="title show-on-phones js-generated"><h5></h5></li>');
            r.find("h5").html(t.html()), n.prepend(r), n.prepend('<li class="back show-on-phones js-generated"><a href="">&larr; Back</a></li>')
        }), n.appendTo(t)
    }
    var t = 0;
    e(".top-bar .name").live("click", function (t) {
        var i = e(this);
        n() && (t.preventDefault(), i.hasClass("top-bar-initialized") || (r(i.closest(".top-bar")), i.addClass("top-bar-initialized")), i.closest(".top-bar").toggleClass("expanded"))
    }), e("body.ie8 .has-dropdown, body.ie7 .has-dropdown").live({
        mouseenter: function () {
            e(this).children(".dropdown").show()
        },
        mouseleave: function () {
            e(this).children(".dropdown").hide()
        }
    }), e(".top-bar .has-dropdown>a").live("click", function (r) {
        if (n()) {
            var i = e(this),
                s = i.closest("li"),
                o = s.find(">ul"),
                u = e('<li class="title show-on-phones js-generated"><h5></h5></li>'),
                a = i.closest(".attached"),
                f = i.closest(".top-bar"),
                l;
            r.preventDefault(), t += 1, s.addClass("active"), a.css({
                left: "-" + 100 * t + "%"
            }), a.find(">.name").css({
                left: 100 * t + "%"
            }), t === 1 && (l = o, o.find("ul.dropdown").each(function () {
                e(this).outerHeight() > l.outerHeight() && (l = e(this))
            }), a.css({
                height: l.outerHeight() + 45 + "px"
            }))
        }
    }), e(".top-bar .has-dropdown .back").live("click", function (n) {
        var r = e(this),
            i = r.closest("li.active"),
            s = r.closest(".attached"),
            o = r.closest(".top-bar"),
            u = i.closest("ul");
        n.preventDefault(), t -= 1, s.css({
            left: "-" + 100 * t + "%"
        }), s.find(">.name").css({
            left: 100 * t + "%"
        }), t === 0 && s.css({
    ...
    var e = $("div.progress-bar");
    $(".devices li a").each(function () {
        target = $("#" + $(this).data("target-id")), target.val() == 1 && $(this).addClass("active")
    }), $(".devices li a").on("click", function (e) {
        e.preventDefault(), target = $("#" + $(this).data("target-id")), target.val() == 0 ? target.val(1) : target.val(0), $(this).toggleClass("active")
    }), $(".notice").length > 0 && ($(".notice").html().length > 1 ? $(".notice").delay(4e3).fadeOut(400) : $(".notice").hide());
    if (e.length > 0) {
        var t = e.children(".filler"),
            n = t.data("count"),
            r = 0;
        n <= 10 ? r = n * 2 : n > 10 && n <= 50 ? r = Math.ceil((n - 10) * .5) + 20 : n > 50 && n <= 100 ? r = Math.ceil((n - 50) * .4) + 40 : n > 100 && n <= 200 ? r = Math.ceil((n - 100) * .2) + 60 : n > 200 && (r = Math.ceil((n - 200) * .066) + 80), t.width(r + "%")
    }
    $("tr.achievement").hover(function () {
        var e = $("#" + $(this).data("achievement-id"));
        e.trigger("mouseover").children("a").children("div.description").css("display", "block")
    }, function () {
        var e = $("#" + $(this).data("achievement-id"));
        e.trigger("mouseout").children("a").children("div.description").css("display", "none")
    }), $(".won").hover(function () {
        $(this).addClass("hovered").siblings(".won:not(.hovered)").css("opacity", "0.3"), $(this).children("a").children("div.description").css("display", "block")
    }, function () {
        $(this).removeClass("hovered").siblings(".won:not(.hovered)").css("opacity", "1.0"), $(this).children("a").children("div.description").css("display", "none")
    })
}), $("#scrollToForm, .scrollToForm").click(function () {
    return $("html, body").animate({
        scrollTop: $(".container.sign-up").offset().top
    }, "slow"), !1
}), $(document).delegate(".verify, .solidify", "click", function () {
